...
<head>
    ...
    <title>Dailyshop - @yield('page_title')</title>
                        ...
                        <div class="aa-header-top-area">
                                ...
                                <div class="aa-language">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                            <li><a href="#"><img src="{{@asset('front_assets/img/flag/french.jpg')}}"
                                                        alt="">FRENCH</a></li>
                                            <li><a href="#"><img src="{{@asset('front_assets/img/flag/english.jpg')}}"
                                                        alt="">ENGLISH</a></li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="aa-header-top-right">
                                <ul class="aa-head-top-nav-right">
                                    ...
                                    <li><a href="javascript:void(0)">{{session('USER_NAME')}}</a></li>
                        ...
                        <div class="aa-header-bottom-area">
                            ...
                            <div class="aa-cartbox">
                                <a class="aa-cart-link" href="javascript:void(0)">
                                    ...
                                    @php
                                    $ShoppingCartItems = ShopingCart();
                                    $totalItems = count($ShoppingCartItems);
                                    $totalPrice = 0;
                                    @endphp
                                    @if(isset($ShoppingCartItems[0]))
                                    <span class="aa-cart-notify">{{$totalItems}}</span>
                                    @else
                                ...
                                @if($totalItems > 0)
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <img src="{{@asset('storage/media/products/'.$item->product_image)}}"
                                                    alt="img" width="150px" height="150px">
                                            </a>
                                            <div class="aa-cartbox-info">
                                                <h4><a href="#">{{$item->product_name}}</a></h4>
                                                <p>{{$item->qty}} x Rs.{{$item->price}}
                                                @if($item->size != '')
                                                <br>Size: {{$item->size}}
                                                @endif
                                                @if($item->color != '')
